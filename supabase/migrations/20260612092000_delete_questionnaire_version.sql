-- Server-only destructive deletion of one questionnaire version and all
-- dependent anonymous spaces, submissions, answers, blocks and questions.
...
comment on function public.delete_questionnaire_version(text) is
  'Server-only destructive deletion of a questionnaire version and all dependent anonymous data.';
